...
fun PantallaUmaMusume(navController: NavHostController) {
    Column(
        modifier = Modifier.fillMaxSize().background(Color.hsv(0F,.3F, .13F)).verticalScroll(rememberScrollState()),
        ...
        Column(
            ...
            Text(
                "Uma Musume Pretty Derby es una franquicia multimedia que presenta un " +
                        ...
                        "intensamente para competir en carreras. \nLa historia sigue a Uma Musume, que heredan " +
